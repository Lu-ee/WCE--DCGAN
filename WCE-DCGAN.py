...
plt.ylabel("Loss")
plt.legend()
fig.savefig(r"./images/ablation/2-DCGAN256/Loss3-500.png", dpi=100)
...
fig.savefig(r"./images/ablation/2-DCGAN256/Realimg-3.png", dpi=100)
...
fig.savefig(r"./images/ablation/2-DCGAN256/Fakeimg3-500.png", dpi=100)
