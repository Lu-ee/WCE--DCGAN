...
plt.ylabel("Loss")
plt.legend()
fig.savefig(r"./images/ablation/4-DCGAN256-0.5/Loss-500.png", dpi=100)
...
fig.savefig(r"./images/ablation/4-DCGAN256-0.5/Realimg.png", dpi=100)
...
fig.savefig(r"./images/ablation/4-DCGAN256-0.5/Fakeimg-500.png", dpi=100)
